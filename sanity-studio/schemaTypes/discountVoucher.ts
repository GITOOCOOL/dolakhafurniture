...
export default defineType({
    ...
    fields: [
        ...
        defineField({
            ...
            title: "Is Welcome Voucher",
            type: "boolean",
            initialValue: false,
            description: "If active, this voucher acts as a 'Welcome Offer'. It will be shown to guests and automatically forces a 'One-time use per customer' rule.",
        }),
        defineField({
            ...
            type: "boolean",
            initialValue: false,
            readOnly: ({ parent }) => parent?.isWelcomeVoucher === true,
            description: "If active, this voucher can only be used once per logged-in account. (Note: Automatically enabled for Welcome Vouchers).",
        }),
        defineField({
            name: "discountType",
            title: "Discount Type",
