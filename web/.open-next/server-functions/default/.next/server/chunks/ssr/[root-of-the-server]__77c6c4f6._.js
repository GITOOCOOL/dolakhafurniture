module.exports = [
  ...
  (a) => {
    ...
    let b = (0, a.i(11857).registerClientReference)(
      function () {
        throw Error(
          "Attempted to call the default export of [project]/src/components/AccountClient.tsx <module evaluation> from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
        );
      },
      "[project]/src/components/AccountClient.tsx <module evaluation>",
      "default",
    );
  },
  45024,
  (a) => {
    ...
    let b = (0, a.i(11857).registerClientReference)(
      function () {
        throw Error(
          "Attempted to call the default export of [project]/src/components/AccountClient.tsx from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
        );
      },
      "[project]/src/components/AccountClient.tsx",
      "default",
    );
  },
  93046,
  ...
  (a) => {
    ...
    a.s([
      ...
      0,
      {
        ...
        description: "Manage your  furniture orders and  profile.",
      },
    ]);
  },
  9489,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__77c6c4f6._.js.map
