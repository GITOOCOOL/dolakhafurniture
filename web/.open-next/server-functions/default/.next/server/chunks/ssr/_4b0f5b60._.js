module.exports = [
  ...
  (a) => {
    "use strict";
    let b = (0, a.i(70106).default)("shield-check", [
      [
        "path",
        {
  ...
  (a) => {
    ...
    var k = a.i(4416),
      l = a.i(96438);
    function m({ product: a }) {
      let [h, m] = (0, c.useState)(1),
        [n, o] = (0, c.useState)(!1),
        p = (0, f.useCart)((a) => a.addItem);
      return (0, b.jsx)("div", {
              ...
              children: [
                (0, b.jsx)("div", {
                  ...
                  children: (0, b.jsx)(d.default, {
                    src: (0, e.urlFor)(a.mainImage).width(1e3).url(),
                    alt: a.title,
                    fill: !0,
                    className:
              ...
              children: [
                    ...
                    (0, b.jsxs)("div", {
                      ...
                      children: [
                        ...
                        (0, b.jsx)("p", {
                          ...
                          children: a.category?.title || "Handcrafted Piece",
                        }),
                      ],
                    }),
                    (0, b.jsx)("h1", {
                ...
                (0, b.jsxs)("div", {
                  ...
                  children: [
                        ...
                        (0, b.jsxs)("div", {
                          ...
                          children: [
                            (0, b.jsx)(l.default, {
                              variant: "ghost",
                              size: "sm",
                              onClick: () => m(Math.max(1, h - 1)),
                              className: "p-2 min-h-0 text-[#a89f91]",
                              leftIcon: (0, b.jsx)(i, { size: 16 }),
                            }),
                            (0, b.jsx)("span", {
                              className:
                    ...
                    (0, b.jsx)(l.default, {
                      onClick: () => {
                        (p(a, h), o(!0), setTimeout(() => o(!1), 2e3));
                      },
                      fullWidth: !0,
                      size: "xl",
                      variant: n ? "accent" : "primary",
                      className: n
                        ? "shadow-[0_20px_40px_rgba(163,87,58,0.3)]"
                        : "hover:shadow-[0_20px_40px_rgba(163,87,58,0.2)]",
                      leftIcon: n
                        ? (0, b.jsx)(k.ShieldCheck, { size: 18 })
                        : void 0,
                      children: n ? "Added to home" : "Add to Cart",
                    }),
                    (0, b.jsx)("p", {
                      className:
...
//# sourceMappingURL=_4b0f5b60._.js.map
