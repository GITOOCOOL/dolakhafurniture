module.exports = [
  ...
  (a, b, c) => {
    ...
    (Object.defineProperty(c, "__esModule", { value: !0 }),
      ...
      a.r(89798).HTTP_ERROR_FALLBACK_ERROR_CODE,
      ("function" == typeof c.default ||
        ("object" == typeof c.default && null !== c.default)) &&
        void 0 === c.default.__esModule &&
        (Object.defineProperty(c.default, "__esModule", { value: !0 }),
  ...
  (a, b, c) => {
    ...
    let d = a.r(94783).unstable_rethrow;
    ("function" == typeof c.default ||
      ("object" == typeof c.default && null !== c.default)) &&
      void 0 === c.default.__esModule &&
      (Object.defineProperty(c.default, "__esModule", { value: !0 }),
  ...
  (a) => {
    ...
    async function o({ params: a }) {
      let { slug: b } = await a,
        c = await f.client.fetch(
          '*[_type == "category" && slug.current == $slug][0]',
          { slug: b },
        );
      return c
        ? { title: `${c.title} | Dolakha ` }
          ...
          children: (0, e.jsxs)("div", {
            ...
            children: [
                ...
                children: [
                  (0, e.jsxs)("div", {
                    ...
                    children: [
                      ...
                      (0, e.jsx)("p", {
                        className:
                          "text-[10px] font-bold uppercase tracking-[0.5em] text-[#a3573a]",
                  ...
                  (0, e.jsxs)("h1", {
                    className:
                      "text-6xl md:text-8xl font-serif italic font-medium text-[#3d2b1f] leading-none mb-10",
                    children: [
                      c.category.title,
                      (0, e.jsx)("span", {
                  ...
                  (0, e.jsxs)("p", {
                    className:
                      "text-lg md:text-xl font-serif italic text-[#a89f91] max-w-2xl leading-relaxed border-l-2 border-[#e5dfd3] pl-6",
                    children: [
                      '"',
              ...
              0 === c.products.length
                ? (0, e.jsx)("div", {
                    className:
                      "py-24 border-t border-[#e5dfd3] border-dotted text-center",
                    children: (0, e.jsx)("p", {
                      className: "text-[#a89f91] italic font-serif text-2xl",
                      children:
                      ...
                      (0, e.jsxs)(
                        g.default,
                        {
                          ...
                          children: [
                            (0, e.jsxs)("div", {
                              className:
                                "aspect-[3/4] relative overflow-hidden rounded-[3rem] bg-white border border-[#e5dfd3] shadow-sm transition-all duration-700 group-hover:shadow-[0_20px_50px_rgba(163,87,58,0.1)] group-hover:border-[#a3573a]/20",
                              children: [
                                (0, e.jsx)("img", {
                                  src: (0, f.urlFor)(a.mainImage)
                                    .width(800)
                                    .url(),
                                  alt: a.title,
                                  className:
                                    "object-cover w-full h-full transition-transform duration-[1.5s] group-hover:scale-110 group-hover:sepia-[0.1]",
                                }),
                                (0, e.jsx)("div", {
                                  className:
                                  ...
                                  children: (0, e.jsx)("span", {
                                    className:
                                      "bg-[#3d2b1f] text-[#fdfaf5] px-8 py-3 rounded-full text-[10px] font-bold uppercase tracking-widest shadow-xl",
                            ...
                            (0, e.jsxs)("div", {
                              ...
                              children: [
                                ...
                                (0, e.jsx)("p", {
                                  ...
                                  children:
                                    a.description ||
                                    "Handcrafted with precision in Dolakha, bringing  elegance to your sanctuary.",
                                }),
                                (0, e.jsx)("div", {
                                  className: "pt-4",
              ...
              (0, e.jsxs)("div", {
                ...
                children: [
                  (0, e.jsxs)("div", {
                    className:
                      "text-[10px] font-medium uppercase tracking-[0.4em] text-[#a89f91]",
                    children: ["Dolakha  / ", c.category.title],
                  }),
                  (0, e.jsx)(g.default, {
                    href: "/",
                    className:
                      "text-[10px] font-bold uppercase tracking-[0.4em] text-[#3d2b1f] hover:text-[#a3573a] transition-colors border-b border-[#3d2b1f] hover:border-[#a3573a] pb-1",
    ...
    a.s(["default", () => p, "generateMetadata", () => o], 33260);
  },
  9489,
  (a) => {
    a.v((b) =>
...
//# sourceMappingURL=%5Broot-of-the-server%5D__847f8156._.js.map
