module.exports = [
  ...
  (a) => {
    ...
    let b = (0, a.i(11857).registerClientReference)(
      function () {
        throw Error(
          "Attempted to call the default export of [project]/src/components/ProductDetail.tsx <module evaluation> from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
        );
      },
      "[project]/src/components/ProductDetail.tsx <module evaluation>",
      "default",
    );
  },
  83030,
  (a) => {
    ...
    let b = (0, a.i(11857).registerClientReference)(
      function () {
        throw Error(
          "Attempted to call the default export of [project]/src/components/ProductDetail.tsx from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.",
        );
      },
      "[project]/src/components/ProductDetail.tsx",
      "default",
    );
  },
  37555,
  ...
  (a) => {
    ...
    async function g({ params: a }) {
      let { slug: b } = await a,
        d = await c.client.fetch(f.productBySlugQuery, { slug: b });
      if (!d) return { title: "Piece Not Found" };
      let e = "A unique,  addition to your home, handcrafted in Kathmandu.",
        g = d.mainImage
          ? (0, c.urlFor)(d.mainImage).width(1200).height(630).url()
          : "/logo.png";
      return {
        title: `${d.title} | Handcrafted at Dolakha Furniture`,
        description: d.description || e,
        openGraph: {
          title: `${d.title} | Dolakha Furniture Home Collection`,
          description: d.description || e,
          images: [{ url: g, width: 1200, height: 630, alt: d.title }],
        },
        twitter: {
    ...
    async function h({ params: a }) {
      let { slug: g } = await a,
        h = await c.client.fetch(f.productBySlugQuery, { slug: g });
      return (
        h || (0, e.notFound)(),
        (0, b.jsx)("div", {
          className:
            "bg-[#fdfaf5] min-h-screen text-[#3d2b1f] selection:bg-[#a3573a]/20",
          children: (0, b.jsx)(d.default, { product: h }),
        })
      );
    }
    a.s(["default", () => h, "generateMetadata", () => g]);
  },
  9489,
  (a) => {
    a.v((b) =>
...
//# sourceMappingURL=%5Broot-of-the-server%5D__157dc69e._.js.map
