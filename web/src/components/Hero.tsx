    ...
    <section className="relative w-full py-24 flex flex-col justify-center bg-app overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          <div className="bg-surface p-10 md:p-14 rounded-[3rem] border border-divider relative shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-8 justify-center items-center">
              ...
              <a href="https://www.facebook.com/dolakhafurniture/" target="_blank" className="flex flex-col items-center gap-3 group">
                ...
                <span className="type-label text-description text-[8px]">Facebook</span>
              </a>
              ...
              <a href="https://www.instagram.com/dolakhafurnituredesign/" target="_blank" className="flex flex-col items-center gap-3 group">
                ...
                <span className="type-label text-description text-[8px]">Instagram</span>
              </a>
              ...
              <a href="mailto:dolakhafurniture@gmail.com" className="flex flex-col items-center gap-3 group">
                ...
                <span className="type-label text-description text-[8px]">Email</span>
              </a>
            </div>
          </div>
