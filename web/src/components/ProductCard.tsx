...
const ProductCard = ({
  ...
  return (
    <div className="group relative flex flex-col overflow-hidden rounded-[2rem] border border-soft bg-surface w-full h-full shadow-sm hover:shadow-md transition-all duration-500 hover:-translate-y-1">
      ...
      <div className="flex flex-col p-3 pt-0 gap-2 mt-auto">
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            ...
            className="flex-1 h-10 flex items-center justify-center rounded-xl bg-success/5 border border-success/20 hover:bg-success hover:text-white transition-all duration-300 group/wa"
          ...
          <a
            ...
            className="flex-1 h-10 flex items-center justify-center rounded-xl bg-action/5 border border-action/20 hover:bg-action hover:text-white transition-all duration-300 group/ms"
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            href={`/product/${product.slug}`}
            className="flex-1 h-10 flex items-center justify-center rounded-xl border border-soft text-[10px] font-sans font-bold uppercase tracking-widest text-heading hover:bg-surface hover:border-action transition-all"
          >
            Details
          </Link>
          ...
          <button
            ...
            className="flex-1 h-10 flex items-center justify-center gap-2 rounded-xl bg-action shadow-md active:translate-y-[1px] hover:bg-heading transition-all duration-300 group/cart"
